...
#include "tesseract_msgs/msg/detail/joint_trajectory__rosidl_typesupport_fastrtps_c.h"
...
#include "tesseract_msgs/msg/detail/joint_state__functions.h"  // states
...
using _JointTrajectory__ros_msg_type = tesseract_msgs__msg__JointTrajectory;
  ...
  // Field name: states
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, tesseract_msgs, msg, JointState
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: states
  {
    ...
    if (ros_message->states.data) {
      tesseract_msgs__msg__JointState__Sequence__fini(&ros_message->states);
    }
  ...
  size_t current_alignment)
{
  ...
  // field.name states
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_tesseract_msgs__msg__JointState(
...
static uint32_t _JointTrajectory__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tesseract_msgs__msg__JointTrajectory(
  ...
  size_t current_alignment)
{
  ...
  // member: states
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        max_serialized_size_tesseract_msgs__msg__JointState(
...
static size_t _JointTrajectory__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tesseract_msgs__msg__JointTrajectory(
