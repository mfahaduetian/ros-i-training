...
#include "tesseract_msgs/msg/detail/contact_margin_pair__rosidl_typesupport_fastrtps_c.h"
...
#include "tesseract_msgs/msg/detail/string_pair__functions.h"  // first
...
using _ContactMarginPair__ros_msg_type = tesseract_msgs__msg__ContactMarginPair;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ContactMarginPair__ros_msg_type * ros_message = static_cast<const _ContactMarginPair__ros_msg_type *>(untyped_ros_message);
  // Field name: first
  {
  ...
  void * untyped_ros_message)
{
  ...
  _ContactMarginPair__ros_msg_type * ros_message = static_cast<_ContactMarginPair__ros_msg_type *>(untyped_ros_message);
  // Field name: first
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _ContactMarginPair__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tesseract_msgs__msg__ContactMarginPair(
...
static size_t _ContactMarginPair__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tesseract_msgs__msg__ContactMarginPair(
...
static message_type_support_callbacks_t __callbacks_ContactMarginPair = {
  "tesseract_msgs::msg",
  "ContactMarginPair",
...
static rosidl_message_type_support_t _ContactMarginPair__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ContactMarginPair,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tesseract_msgs, msg, ContactMarginPair)() {
  return &_ContactMarginPair__type_support;
}
