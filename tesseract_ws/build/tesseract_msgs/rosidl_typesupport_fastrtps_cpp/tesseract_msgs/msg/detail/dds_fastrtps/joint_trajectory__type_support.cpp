...
#include "tesseract_msgs/msg/detail/joint_trajectory__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const tesseract_msgs::msg::JointState &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  tesseract_msgs::msg::JointState &);
...
cdr_serialize(
  const tesseract_msgs::msg::JointTrajectory & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tesseract_msgs::msg::JointTrajectory & ros_message)
{
  // Member: states
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  // Member: states
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        tesseract_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_JointState(
...
{
  auto typed_message =
    static_cast<const tesseract_msgs::msg::JointTrajectory *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tesseract_msgs::msg::JointTrajectory *>(
    untyped_ros_message);
...
{
  return &tesseract_msgs::msg::typesupport_fastrtps_cpp::_JointTrajectory__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tesseract_msgs, msg, JointTrajectory)() {
  return &tesseract_msgs::msg::typesupport_fastrtps_cpp::_JointTrajectory__handle;
}
