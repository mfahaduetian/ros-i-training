...
public:
    ...
    void retranslateUi(QWidget *DraggableToolbar)
    {
        ...
        buttonFullscreen->setText(QCoreApplication::translate("DraggableToolbar", "F", nullptr));
#if QT_CONFIG(tooltip)
        buttonClose->setToolTip(QCoreApplication::translate("DraggableToolbar", "<html><head/><body><p>Close Plot Area</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
        buttonClose->setText(QCoreApplication::translate("DraggableToolbar", "C", nullptr));
    } // retranslateUi
