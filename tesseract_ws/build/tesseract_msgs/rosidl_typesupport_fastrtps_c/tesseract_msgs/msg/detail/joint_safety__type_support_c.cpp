...
#include "tesseract_msgs/msg/detail/joint_safety__rosidl_typesupport_fastrtps_c.h"
...
using _JointSafety__ros_msg_type = tesseract_msgs__msg__JointSafety;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _JointSafety__ros_msg_type * ros_message = static_cast<const _JointSafety__ros_msg_type *>(untyped_ros_message);
  // Field name: soft_upper_limit
  {
    cdr << ros_message->soft_upper_limit;
  }

  // Field name: soft_lower_limit
  {
  ...
  void * untyped_ros_message)
{
  ...
  _JointSafety__ros_msg_type * ros_message = static_cast<_JointSafety__ros_msg_type *>(untyped_ros_message);
  // Field name: soft_upper_limit
  {
    cdr >> ros_message->soft_upper_limit;
  }
...
static uint32_t _JointSafety__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tesseract_msgs__msg__JointSafety(
...
static size_t _JointSafety__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tesseract_msgs__msg__JointSafety(
...
static message_type_support_callbacks_t __callbacks_JointSafety = {
  "tesseract_msgs::msg",
  "JointSafety",
...
static rosidl_message_type_support_t _JointSafety__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_JointSafety,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tesseract_msgs, msg, JointSafety)() {
  return &_JointSafety__type_support;
}
