...
#include "tesseract_msgs/msg/detail/transform_map__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/pose__functions.h"  // transforms
...
using _TransformMap__ros_msg_type = tesseract_msgs__msg__TransformMap;

static bool _TransformMap__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _TransformMap__ros_msg_type * ros_message = static_cast<const _TransformMap__ros_msg_type *>(untyped_ros_message);
  // Field name: names
  {
...
static bool _TransformMap__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _TransformMap__ros_msg_type * ros_message = static_cast<_TransformMap__ros_msg_type *>(untyped_ros_message);
  // Field name: names
  {
    uint32_t cdrSize;
    cdr >> cdrSize;
  ...
  // Field name: transforms
  {
    ...
    if (ros_message->transforms.data) {
      geometry_msgs__msg__Pose__Sequence__fini(&ros_message->transforms);
    }
...
static uint32_t _TransformMap__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tesseract_msgs__msg__TransformMap(
...
static size_t _TransformMap__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_tesseract_msgs__msg__TransformMap(
...
static message_type_support_callbacks_t __callbacks_TransformMap = {
  "tesseract_msgs::msg",
  "TransformMap",
  _TransformMap__cdr_serialize,
  _TransformMap__cdr_deserialize,
  _TransformMap__get_serialized_size,
  _TransformMap__max_serialized_size
};

static rosidl_message_type_support_t _TransformMap__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_TransformMap,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tesseract_msgs, msg, TransformMap)() {
  return &_TransformMap__type_support;
}
