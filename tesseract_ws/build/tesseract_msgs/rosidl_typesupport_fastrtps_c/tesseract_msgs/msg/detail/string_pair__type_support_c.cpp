...
#include "tesseract_msgs/msg/detail/string_pair__rosidl_typesupport_fastrtps_c.h"
...
using _StringPair__ros_msg_type = tesseract_msgs__msg__StringPair;
...
static uint32_t _StringPair__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tesseract_msgs__msg__StringPair(
...
static size_t _StringPair__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tesseract_msgs__msg__StringPair(
