...
#ifndef TESSERACT_MSGS__MSG__DETAIL__JOINT_DYNAMICS__STRUCT_HPP_
#define TESSERACT_MSGS__MSG__DETAIL__JOINT_DYNAMICS__STRUCT_HPP_
...
struct JointDynamics_
{
  ...
  explicit JointDynamics_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
  ...
  explicit JointDynamics_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
...
#endif  // TESSERACT_MSGS__MSG__DETAIL__JOINT_DYNAMICS__STRUCT_HPP_
