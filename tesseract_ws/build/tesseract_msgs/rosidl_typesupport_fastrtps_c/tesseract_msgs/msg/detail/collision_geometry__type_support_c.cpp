...
#include "tesseract_msgs/msg/detail/collision_geometry__rosidl_typesupport_fastrtps_c.h"
...
using _CollisionGeometry__ros_msg_type = tesseract_msgs__msg__CollisionGeometry;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _CollisionGeometry__ros_msg_type * ros_message = static_cast<const _CollisionGeometry__ros_msg_type *>(untyped_ros_message);
  // Field name: name
  {
  ...
  void * untyped_ros_message)
{
  ...
  _CollisionGeometry__ros_msg_type * ros_message = static_cast<_CollisionGeometry__ros_msg_type *>(untyped_ros_message);
  // Field name: name
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _CollisionGeometry__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tesseract_msgs__msg__CollisionGeometry(
...
static size_t _CollisionGeometry__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tesseract_msgs__msg__CollisionGeometry(
...
static message_type_support_callbacks_t __callbacks_CollisionGeometry = {
  "tesseract_msgs::msg",
  "CollisionGeometry",
...
static rosidl_message_type_support_t _CollisionGeometry__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_CollisionGeometry,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tesseract_msgs, msg, CollisionGeometry)() {
  return &_CollisionGeometry__type_support;
}
