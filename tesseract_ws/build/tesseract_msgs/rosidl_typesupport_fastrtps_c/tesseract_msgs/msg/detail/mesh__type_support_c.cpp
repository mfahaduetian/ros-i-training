...
#include "tesseract_msgs/msg/detail/mesh__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // faces
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // faces
...
using _Mesh__ros_msg_type = tesseract_msgs__msg__Mesh;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: faces
  {
    ...
    if (ros_message->faces.data) {
      rosidl_runtime_c__uint32__Sequence__fini(&ros_message->faces);
    }
    if (!rosidl_runtime_c__uint32__Sequence__init(&ros_message->faces, size)) {
...
static uint32_t _Mesh__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tesseract_msgs__msg__Mesh(
...
static size_t _Mesh__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tesseract_msgs__msg__Mesh(
