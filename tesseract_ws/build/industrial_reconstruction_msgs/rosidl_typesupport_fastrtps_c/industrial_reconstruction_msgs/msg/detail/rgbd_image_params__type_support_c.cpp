...
#include "industrial_reconstruction_msgs/msg/detail/rgbd_image_params__rosidl_typesupport_fastrtps_c.h"
...
using _RGBDImageParams__ros_msg_type = industrial_reconstruction_msgs__msg__RGBDImageParams;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _RGBDImageParams__ros_msg_type * ros_message = static_cast<const _RGBDImageParams__ros_msg_type *>(untyped_ros_message);
  // Field name: depth_scale
  {
    cdr << ros_message->depth_scale;
  }

  // Field name: depth_trunc
  {
    cdr << ros_message->depth_trunc;
  }

  // Field name: convert_rgb_to_intensity
  {
  ...
  void * untyped_ros_message)
{
  ...
  _RGBDImageParams__ros_msg_type * ros_message = static_cast<_RGBDImageParams__ros_msg_type *>(untyped_ros_message);
  // Field name: depth_scale
  {
    cdr >> ros_message->depth_scale;
  }
...
static uint32_t _RGBDImageParams__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_industrial_reconstruction_msgs__msg__RGBDImageParams(
...
static size_t _RGBDImageParams__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_industrial_reconstruction_msgs__msg__RGBDImageParams(
...
static message_type_support_callbacks_t __callbacks_RGBDImageParams = {
...
static rosidl_message_type_support_t _RGBDImageParams__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_RGBDImageParams,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, industrial_reconstruction_msgs, msg, RGBDImageParams)() {
  return &_RGBDImageParams__type_support;
}
