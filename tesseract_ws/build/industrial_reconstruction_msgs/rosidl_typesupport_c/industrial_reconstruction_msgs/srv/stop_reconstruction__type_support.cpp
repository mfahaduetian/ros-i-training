...
static const _StopReconstruction_Request_type_support_symbol_names_t _StopReconstruction_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, industrial_reconstruction_msgs, srv, StopReconstruction_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, industrial_reconstruction_msgs, srv, StopReconstruction_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, industrial_reconstruction_msgs, srv, StopReconstruction_Request)() {
  return &::industrial_reconstruction_msgs::srv::rosidl_typesupport_c::StopReconstruction_Request_message_type_support_handle;
}
...
static const _StopReconstruction_Response_type_support_symbol_names_t _StopReconstruction_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, industrial_reconstruction_msgs, srv, StopReconstruction_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, industrial_reconstruction_msgs, srv, StopReconstruction_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, industrial_reconstruction_msgs, srv, StopReconstruction_Response)() {
  return &::industrial_reconstruction_msgs::srv::rosidl_typesupport_c::StopReconstruction_Response_message_type_support_handle;
}
...
static const _StopReconstruction_type_support_symbol_names_t _StopReconstruction_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, industrial_reconstruction_msgs, srv, StopReconstruction)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, industrial_reconstruction_msgs, srv, StopReconstruction)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, industrial_reconstruction_msgs, srv, StopReconstruction)() {
  return &::industrial_reconstruction_msgs::srv::rosidl_typesupport_c::StopReconstruction_service_type_support_handle;
}
