...
#include "tesseract_msgs/msg/detail/link__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const tesseract_msgs::msg::Inertial &,
...
{
bool cdr_serialize(
  const tesseract_msgs::msg::VisualGeometry &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
{
bool cdr_serialize(
  const tesseract_msgs::msg::CollisionGeometry &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ...
  size_t current_alignment)
{
  ...
  // Member: inertial
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        tesseract_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Inertial(
  ...
  // Member: visual
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        tesseract_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_VisualGeometry(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
  ...
  // Member: collision
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        tesseract_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_CollisionGeometry(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
...
{
  auto typed_message =
    static_cast<const tesseract_msgs::msg::Link *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tesseract_msgs::msg::Link *>(
    untyped_ros_message);
...
{
  return &tesseract_msgs::msg::typesupport_fastrtps_cpp::_Link__handle;
}
