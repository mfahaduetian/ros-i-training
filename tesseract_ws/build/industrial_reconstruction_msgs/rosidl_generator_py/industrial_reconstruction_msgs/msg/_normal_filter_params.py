...
class Metaclass_NormalFilterParams(type):
    """Metaclass of message 'NormalFilterParams'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__normal_filter_params
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__normal_filter_params
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__normal_filter_params
            cls._TYPE_SUPPORT = module.type_support_msg__msg__normal_filter_params
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__normal_filter_params
...
class NormalFilterParams(metaclass=Metaclass_NormalFilterParams):
    """Message class 'NormalFilterParams'."""
