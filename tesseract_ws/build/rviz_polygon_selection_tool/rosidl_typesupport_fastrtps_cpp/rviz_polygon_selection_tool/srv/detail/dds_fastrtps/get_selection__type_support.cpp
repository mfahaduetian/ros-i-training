...
#include "rviz_polygon_selection_tool/srv/detail/get_selection__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const rviz_polygon_selection_tool::srv::GetSelection_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rviz_polygon_selection_tool::srv::GetSelection_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GetSelection_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const rviz_polygon_selection_tool::srv::GetSelection_Request *>(
...
static size_t _GetSelection_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetSelection_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GetSelection_Request__callbacks = {
...
static rosidl_message_type_support_t _GetSelection_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetSelection_Request__callbacks,
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_rviz_polygon_selection_tool
const rosidl_message_type_support_t *
get_message_type_support_handle<rviz_polygon_selection_tool::srv::GetSelection_Request>()
{
  return &rviz_polygon_selection_tool::srv::typesupport_fastrtps_cpp::_GetSelection_Request__handle;
}
  ...
  rviz_polygon_selection_tool::srv::GetSelection_Response & ros_message)
{
  // Member: selection
  {
    ...
    ros_message.selection.resize(size);
    for (size_t i = 0; i < size; i++) {
      geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.selection[i]);
    }
  }
  ...
  // Member: selection
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.selection[index], current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const rviz_polygon_selection_tool::srv::GetSelection_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<rviz_polygon_selection_tool::srv::GetSelection_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GetSelection_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const rviz_polygon_selection_tool::srv::GetSelection_Response *>(
...
static size_t _GetSelection_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetSelection_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GetSelection_Response__callbacks = {
  "rviz_polygon_selection_tool::srv",
...
static rosidl_message_type_support_t _GetSelection_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetSelection_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &rviz_polygon_selection_tool::srv::typesupport_fastrtps_cpp::_GetSelection_Response__handle;
}
...
static service_type_support_callbacks_t _GetSelection__callbacks = {
  "rviz_polygon_selection_tool::srv",
  "GetSelection",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rviz_polygon_selection_tool, srv, GetSelection_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rviz_polygon_selection_tool, srv, GetSelection_Response)(),
...
static rosidl_service_type_support_t _GetSelection__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetSelection__callbacks,
...
{
  return &rviz_polygon_selection_tool::srv::typesupport_fastrtps_cpp::_GetSelection__handle;
}
