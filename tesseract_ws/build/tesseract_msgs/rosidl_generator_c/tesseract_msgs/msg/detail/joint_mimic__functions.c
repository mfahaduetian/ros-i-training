...
tesseract_msgs__msg__JointMimic__create()
{
  ...
  tesseract_msgs__msg__JointMimic * msg = (tesseract_msgs__msg__JointMimic *)allocator.allocate(sizeof(tesseract_msgs__msg__JointMimic), allocator.state);
  if (!msg) {
    return NULL;
  }
...
tesseract_msgs__msg__JointMimic__Sequence__init(tesseract_msgs__msg__JointMimic__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tesseract_msgs__msg__JointMimic *)allocator.zero_allocate(size, sizeof(tesseract_msgs__msg__JointMimic), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tesseract_msgs__msg__JointMimic__Sequence * array = (tesseract_msgs__msg__JointMimic__Sequence *)allocator.allocate(sizeof(tesseract_msgs__msg__JointMimic__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
tesseract_msgs__msg__JointMimic__Sequence__are_equal(const tesseract_msgs__msg__JointMimic__Sequence * lhs, const tesseract_msgs__msg__JointMimic__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tesseract_msgs__msg__JointMimic__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  tesseract_msgs__msg__JointMimic__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tesseract_msgs__msg__JointMimic);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    tesseract_msgs__msg__JointMimic * data =
      (tesseract_msgs__msg__JointMimic *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tesseract_msgs__msg__JointMimic__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tesseract_msgs__msg__JointMimic__fini(&output->data[i]);
        }
        return false;
      }
    }
