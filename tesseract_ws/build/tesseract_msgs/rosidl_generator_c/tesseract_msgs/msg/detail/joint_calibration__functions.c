...
tesseract_msgs__msg__JointCalibration__are_equal(const tesseract_msgs__msg__JointCalibration * lhs, const tesseract_msgs__msg__JointCalibration * rhs)
{
  ...
  // reference_position
  if (lhs->reference_position != rhs->reference_position) {
    return false;
  }
  // rising
  if (lhs->rising != rhs->rising) {
    return false;
  }
  // falling
  if (lhs->falling != rhs->falling) {
    return false;
  }
  // empty
  ...
  tesseract_msgs__msg__JointCalibration * output)
{
  ...
  // reference_position
  output->reference_position = input->reference_position;
  // rising
  output->rising = input->rising;
  // falling
  output->falling = input->falling;
  // empty
...
tesseract_msgs__msg__JointCalibration__create()
{
  ...
  tesseract_msgs__msg__JointCalibration * msg = (tesseract_msgs__msg__JointCalibration *)allocator.allocate(sizeof(tesseract_msgs__msg__JointCalibration), allocator.state);
  if (!msg) {
    return NULL;
  }
...
tesseract_msgs__msg__JointCalibration__Sequence__init(tesseract_msgs__msg__JointCalibration__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tesseract_msgs__msg__JointCalibration *)allocator.zero_allocate(size, sizeof(tesseract_msgs__msg__JointCalibration), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tesseract_msgs__msg__JointCalibration__Sequence * array = (tesseract_msgs__msg__JointCalibration__Sequence *)allocator.allocate(sizeof(tesseract_msgs__msg__JointCalibration__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
tesseract_msgs__msg__JointCalibration__Sequence__are_equal(const tesseract_msgs__msg__JointCalibration__Sequence * lhs, const tesseract_msgs__msg__JointCalibration__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tesseract_msgs__msg__JointCalibration__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  tesseract_msgs__msg__JointCalibration__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tesseract_msgs__msg__JointCalibration);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    tesseract_msgs__msg__JointCalibration * data =
      (tesseract_msgs__msg__JointCalibration *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tesseract_msgs__msg__JointCalibration__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tesseract_msgs__msg__JointCalibration__fini(&output->data[i]);
        }
        return false;
      }
    }
