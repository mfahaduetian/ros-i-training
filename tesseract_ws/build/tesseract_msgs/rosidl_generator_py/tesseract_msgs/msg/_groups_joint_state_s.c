...
bool tesseract_msgs__msg__groups_joint_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tesseract_msgs.msg._groups_joint_state.GroupsJointState", full_classname_dest, 55) == 0);
  }
  tesseract_msgs__msg__GroupsJointState * ros_message = _ros_message;
  {  // name
  ...
  {  // joint_state
    ...
    tesseract_msgs__msg__StringDoublePair * dest = ros_message->joint_state.data;
...
{
  /* NOTE(esteve): Call constructor of GroupsJointState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tesseract_msgs.msg._groups_joint_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GroupsJointState");
  ...
  {  // joint_state
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->joint_state.data[i]);
