...
bool tesseract_msgs__msg__string_double_pair__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tesseract_msgs.msg._string_double_pair.StringDoublePair", full_classname_dest, 55) == 0);
  }
  tesseract_msgs__msg__StringDoublePair * ros_message = _ros_message;
  {  // first
...
{
  /* NOTE(esteve): Call constructor of StringDoublePair */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tesseract_msgs.msg._string_double_pair");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "StringDoublePair");
