...
set_target_properties(ads::qtadvanceddocking PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/libqtadvanceddocking.so.3.8.2"
  IMPORTED_SONAME_NOCONFIG "libqtadvanceddocking.so.3.8.2"
  )

list(APPEND _IMPORT_CHECK_TARGETS ads::qtadvanceddocking )
list(APPEND _IMPORT_CHECK_FILES_FOR_ads::qtadvanceddocking "${_IMPORT_PREFIX}/lib/libqtadvanceddocking.so.3.8.2" )
