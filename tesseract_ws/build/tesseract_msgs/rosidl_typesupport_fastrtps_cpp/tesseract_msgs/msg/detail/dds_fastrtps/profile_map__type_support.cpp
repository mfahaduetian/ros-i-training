...
#include "tesseract_msgs/msg/detail/profile_map__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tesseract_msgs::msg::ProfileMap & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tesseract_msgs::msg::ProfileMap & ros_message)
{
  // Member: pairs
  {
    uint32_t cdrSize;
  ...
  // Member: pairs
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.pairs[index], current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const tesseract_msgs::msg::ProfileMap *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tesseract_msgs::msg::ProfileMap *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ProfileMap__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const tesseract_msgs::msg::ProfileMap *>(
...
static size_t _ProfileMap__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ProfileMap(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ProfileMap__callbacks = {
  "tesseract_msgs::msg",
  "ProfileMap",
...
static rosidl_message_type_support_t _ProfileMap__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ProfileMap__callbacks,
...
{
  return &tesseract_msgs::msg::typesupport_fastrtps_cpp::_ProfileMap__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tesseract_msgs, msg, ProfileMap)() {
  return &tesseract_msgs::msg::typesupport_fastrtps_cpp::_ProfileMap__handle;
}
