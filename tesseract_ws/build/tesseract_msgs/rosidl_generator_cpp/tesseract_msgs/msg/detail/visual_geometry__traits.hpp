...
#ifndef TESSERACT_MSGS__MSG__DETAIL__VISUAL_GEOMETRY__TRAITS_HPP_
#define TESSERACT_MSGS__MSG__DETAIL__VISUAL_GEOMETRY__TRAITS_HPP_
...
inline std::string to_yaml(const VisualGeometry & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const tesseract_msgs::msg::VisualGeometry & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const tesseract_msgs::msg::VisualGeometry & msg)
{
...
template<>
inline const char * name<tesseract_msgs::msg::VisualGeometry>()
{
  return "tesseract_msgs/msg/VisualGeometry";
}
...
#endif  // TESSERACT_MSGS__MSG__DETAIL__VISUAL_GEOMETRY__TRAITS_HPP_
