...
#include "tesseract_msgs/msg/detail/scene_graph__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // disabled_collision_links, id, invisible_links, root
#include "rosidl_runtime_c/string_functions.h"  // disabled_collision_links, id, invisible_links, root
#include "tesseract_msgs/msg/detail/allowed_collision_entry__functions.h"  // acm
...
using _SceneGraph__ros_msg_type = tesseract_msgs__msg__SceneGraph;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _SceneGraph__ros_msg_type * ros_message = static_cast<const _SceneGraph__ros_msg_type *>(untyped_ros_message);
  // Field name: id
  {
  ...
  // Field name: root
  {
    const rosidl_runtime_c__String * str = &ros_message->root;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  // Field name: invisible_links
  {
    size_t size = ros_message->invisible_links.size;
    auto array_ptr = ros_message->invisible_links.data;
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
  ...
  // Field name: disabled_collision_links
  {
    size_t size = ros_message->disabled_collision_links.size;
    auto array_ptr = ros_message->disabled_collision_links.data;
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      const rosidl_runtime_c__String * str = &array_ptr[i];
      if (str->capacity == 0 || str->capacity <= str->size) {
  ...
  // Field name: acm
  {
    ...
    auto array_ptr = ros_message->acm.data;
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_serialize(
          &array_ptr[i], cdr))
  ...
  void * untyped_ros_message)
{
  ...
  _SceneGraph__ros_msg_type * ros_message = static_cast<_SceneGraph__ros_msg_type *>(untyped_ros_message);
  // Field name: id
  {
    std::string tmp;
    cdr >> tmp;
  ...
  // Field name: root
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->root.data) {
      rosidl_runtime_c__String__init(&ros_message->root);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->root,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'root'\n");
      return false;
    }
  }
  ...
  // Field name: invisible_links
  {
    ...
    cdr >> cdrSize;
    size_t size = static_cast<size_t>(cdrSize);
    if (ros_message->invisible_links.data) {
      rosidl_runtime_c__String__Sequence__fini(&ros_message->invisible_links);
    }
    if (!rosidl_runtime_c__String__Sequence__init(&ros_message->invisible_links, size)) {
      fprintf(stderr, "failed to create array for field 'invisible_links'");
      return false;
    }
    auto array_ptr = ros_message->invisible_links.data;
    for (size_t i = 0; i < size; ++i) {
      ...
      bool succeeded = rosidl_runtime_c__String__assign(
        ...
        tmp.c_str());
      if (!succeeded) {
        fprintf(stderr, "failed to assign string into field 'invisible_links'\n");
        return false;
      }
    }
  }
  ...
  // Field name: disabled_collision_links
  {
    ...
    cdr >> cdrSize;
    size_t size = static_cast<size_t>(cdrSize);
    if (ros_message->disabled_collision_links.data) {
      rosidl_runtime_c__String__Sequence__fini(&ros_message->disabled_collision_links);
    }
    if (!rosidl_runtime_c__String__Sequence__init(&ros_message->disabled_collision_links, size)) {
      fprintf(stderr, "failed to create array for field 'disabled_collision_links'");
      return false;
    }
    auto array_ptr = ros_message->disabled_collision_links.data;
    for (size_t i = 0; i < size; ++i) {
      ...
      bool succeeded = rosidl_runtime_c__String__assign(
        ...
        tmp.c_str());
      if (!succeeded) {
        fprintf(stderr, "failed to assign string into field 'disabled_collision_links'\n");
        return false;
      }
    }
  }
  ...
  // Field name: acm
  {
    ...
    cdr >> cdrSize;
    size_t size = static_cast<size_t>(cdrSize);
    if (ros_message->acm.data) {
      tesseract_msgs__msg__AllowedCollisionEntry__Sequence__fini(&ros_message->acm);
    }
    if (!tesseract_msgs__msg__AllowedCollisionEntry__Sequence__init(&ros_message->acm, size)) {
      fprintf(stderr, "failed to create array for field 'acm'");
      return false;
    }
    auto array_ptr = ros_message->acm.data;
    for (size_t i = 0; i < size; ++i) {
...
static uint32_t _SceneGraph__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tesseract_msgs__msg__SceneGraph(
...
static size_t _SceneGraph__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tesseract_msgs__msg__SceneGraph(
...
static message_type_support_callbacks_t __callbacks_SceneGraph = {
  "tesseract_msgs::msg",
  "SceneGraph",
