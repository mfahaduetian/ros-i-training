...
set(_exported_libraries "tesseract_msgs__rosidl_generator_c;tesseract_msgs__rosidl_typesupport_c;tesseract_msgs__rosidl_typesupport_cpp")
  ...
  while(_i LESS _length)
    ...
    if(NOT _library_dirs)
      ...
      if(NOT _lib)
        # warn about not existing library and later ignore it
        message(WARNING
          "Package 'tesseract_msgs' exports library '${_library_name}' with LIBRARY_DIRS '${_library_dirs}' which couldn't be found")
      endif()
    endif()
    if(_lib)
      list(APPEND tesseract_msgs_LIBRARIES ${_cfg} "${_lib}")
