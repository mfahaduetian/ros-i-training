...
: ${AMENT_CURRENT_PREFIX:="/home/ubuntu/tesseract_ws/install/snp_application"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/snp_application/environment/library_path.sh"
