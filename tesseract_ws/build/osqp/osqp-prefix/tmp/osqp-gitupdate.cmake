...
execute_process(
  COMMAND "/usr/bin/git" show-ref "v0.6.2"
  WORKING_DIRECTORY "/home/ubuntu/tesseract_ws/build/osqp-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/ubuntu/tesseract_ws/build/osqp-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/ubuntu/tesseract_ws/build/osqp-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
