...
bool tesseract_msgs__srv__modify_environment__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tesseract_msgs.srv._modify_environment.ModifyEnvironment_Request", full_classname_dest, 64) == 0);
  }
...
bool tesseract_msgs__srv__modify_environment__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tesseract_msgs.srv._modify_environment.ModifyEnvironment_Response", full_classname_dest, 65) == 0);
  }
