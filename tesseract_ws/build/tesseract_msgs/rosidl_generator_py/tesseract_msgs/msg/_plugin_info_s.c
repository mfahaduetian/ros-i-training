...
bool tesseract_msgs__msg__plugin_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tesseract_msgs.msg._plugin_info.PluginInfo", full_classname_dest, 42) == 0);
  }
  tesseract_msgs__msg__PluginInfo * ros_message = _ros_message;
  {  // class_name
...
{
  /* NOTE(esteve): Call constructor of PluginInfo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tesseract_msgs.msg._plugin_info");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PluginInfo");
