...
void fetch_function__ModifyEnvironment_Request__commands(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const tesseract_msgs::msg::EnvironmentCommand *>(
    get_const_function__ModifyEnvironment_Request__commands(untyped_member, index));
  auto & value = *reinterpret_cast<tesseract_msgs::msg::EnvironmentCommand *>(untyped_value);
  value = item;
}

void assign_function__ModifyEnvironment_Request__commands(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<tesseract_msgs::msg::EnvironmentCommand *>(
    get_function__ModifyEnvironment_Request__commands(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ModifyEnvironment_Request_message_member_array[4] = {
  {
    "id",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tesseract_msgs::srv::ModifyEnvironment_Request, append),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    fetch_function__ModifyEnvironment_Request__commands,  // fetch(index, &value) function pointer
    assign_function__ModifyEnvironment_Request__commands,  // assign(index, value) function pointer
