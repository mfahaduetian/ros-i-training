...
tesseract_msgs__msg__GroupsJointStates__init(tesseract_msgs__msg__GroupsJointStates * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->name)) {
    tesseract_msgs__msg__GroupsJointStates__fini(msg);
    return false;
  }
  // joint_states
  if (!tesseract_msgs__msg__GroupsJointState__Sequence__init(&msg->joint_states, 0)) {
    tesseract_msgs__msg__GroupsJointStates__fini(msg);
    return false;
  }
  return true;
...
tesseract_msgs__msg__GroupsJointStates__fini(tesseract_msgs__msg__GroupsJointStates * msg)
{
  ...
  // joint_states
  tesseract_msgs__msg__GroupsJointState__Sequence__fini(&msg->joint_states);
}
...
tesseract_msgs__msg__GroupsJointStates__are_equal(const tesseract_msgs__msg__GroupsJointStates * lhs, const tesseract_msgs__msg__GroupsJointStates * rhs)
{
  ...
  // joint_states
  if (!tesseract_msgs__msg__GroupsJointState__Sequence__are_equal(
  ...
  tesseract_msgs__msg__GroupsJointStates * output)
{
  ...
  // joint_states
  if (!tesseract_msgs__msg__GroupsJointState__Sequence__copy(
...
tesseract_msgs__msg__GroupsJointStates__create()
{
  ...
  tesseract_msgs__msg__GroupsJointStates * msg = (tesseract_msgs__msg__GroupsJointStates *)allocator.allocate(sizeof(tesseract_msgs__msg__GroupsJointStates), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(tesseract_msgs__msg__GroupsJointStates));
  bool success = tesseract_msgs__msg__GroupsJointStates__init(msg);
  if (!success) {
...
tesseract_msgs__msg__GroupsJointStates__Sequence__init(tesseract_msgs__msg__GroupsJointStates__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tesseract_msgs__msg__GroupsJointStates * data = NULL;

  if (size) {
    data = (tesseract_msgs__msg__GroupsJointStates *)allocator.zero_allocate(size, sizeof(tesseract_msgs__msg__GroupsJointStates), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = tesseract_msgs__msg__GroupsJointStates__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        tesseract_msgs__msg__GroupsJointStates__fini(&data[i - 1]);
      }
...
tesseract_msgs__msg__GroupsJointStates__Sequence__fini(tesseract_msgs__msg__GroupsJointStates__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      tesseract_msgs__msg__GroupsJointStates__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tesseract_msgs__msg__GroupsJointStates__Sequence * array = (tesseract_msgs__msg__GroupsJointStates__Sequence *)allocator.allocate(sizeof(tesseract_msgs__msg__GroupsJointStates__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = tesseract_msgs__msg__GroupsJointStates__Sequence__init(array, size);
  if (!success) {
...
tesseract_msgs__msg__GroupsJointStates__Sequence__destroy(tesseract_msgs__msg__GroupsJointStates__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    tesseract_msgs__msg__GroupsJointStates__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
tesseract_msgs__msg__GroupsJointStates__Sequence__are_equal(const tesseract_msgs__msg__GroupsJointStates__Sequence * lhs, const tesseract_msgs__msg__GroupsJointStates__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tesseract_msgs__msg__GroupsJointStates__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  tesseract_msgs__msg__GroupsJointStates__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tesseract_msgs__msg__GroupsJointStates);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    tesseract_msgs__msg__GroupsJointStates * data =
      (tesseract_msgs__msg__GroupsJointStates *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tesseract_msgs__msg__GroupsJointStates__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tesseract_msgs__msg__GroupsJointStates__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!tesseract_msgs__msg__GroupsJointStates__copy(
