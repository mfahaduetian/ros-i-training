...
#include "tesseract_msgs/msg/detail/trajectory__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // description, instructions, ns
#include "rosidl_runtime_c/string_functions.h"  // description, instructions, ns
#include "std_msgs/msg/detail/header__functions.h"  // header
#include "tesseract_msgs/msg/detail/environment__functions.h"  // environment
#include "tesseract_msgs/msg/detail/environment_command__functions.h"  // commands
#include "tesseract_msgs/msg/detail/joint_trajectory__functions.h"  // joint_trajectories
...
size_t get_serialized_size_tesseract_msgs__msg__Environment(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_tesseract_msgs__msg__Environment(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tesseract_msgs, msg, Environment)();
...
using _Trajectory__ros_msg_type = tesseract_msgs__msg__Trajectory;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: environment
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, tesseract_msgs, msg, Environment
      )()->data);
    if (!callbacks->cdr_serialize(
        &ros_message->environment, cdr))
    {
      return false;
    }
  }
  ...
  // Field name: joint_trajectories
  {
    ...
    auto array_ptr = ros_message->joint_trajectories.data;
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_serialize(
          &array_ptr[i], cdr))
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: joint_trajectories
  {
    ...
    cdr >> cdrSize;
    size_t size = static_cast<size_t>(cdrSize);
    if (ros_message->joint_trajectories.data) {
      tesseract_msgs__msg__JointTrajectory__Sequence__fini(&ros_message->joint_trajectories);
    }
    if (!tesseract_msgs__msg__JointTrajectory__Sequence__init(&ros_message->joint_trajectories, size)) {
      fprintf(stderr, "failed to create array for field 'joint_trajectories'");
      return false;
    }
    auto array_ptr = ros_message->joint_trajectories.data;
    for (size_t i = 0; i < size; ++i) {
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_tesseract_msgs__msg__Environment(
...
static uint32_t _Trajectory__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tesseract_msgs__msg__Trajectory(
  ...
  size_t current_alignment)
{
  ...
  // member: environment
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        max_serialized_size_tesseract_msgs__msg__Environment(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
...
static size_t _Trajectory__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tesseract_msgs__msg__Trajectory(
