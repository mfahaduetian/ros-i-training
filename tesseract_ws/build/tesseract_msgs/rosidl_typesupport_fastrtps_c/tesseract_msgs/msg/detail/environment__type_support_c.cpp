...
#include "tesseract_msgs/msg/detail/environment__rosidl_typesupport_fastrtps_c.h"
...
using _Environment__ros_msg_type = tesseract_msgs__msg__Environment;
...
static uint32_t _Environment__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tesseract_msgs__msg__Environment(
...
static size_t _Environment__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tesseract_msgs__msg__Environment(
