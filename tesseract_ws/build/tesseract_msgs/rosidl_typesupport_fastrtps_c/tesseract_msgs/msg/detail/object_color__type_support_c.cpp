...
#include "tesseract_msgs/msg/detail/object_color__rosidl_typesupport_fastrtps_c.h"
...
#include "std_msgs/msg/detail/color_rgba__functions.h"  // collision, visual
...
using _ObjectColor__ros_msg_type = tesseract_msgs__msg__ObjectColor;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: visual
  {
    ...
    if (ros_message->visual.data) {
      std_msgs__msg__ColorRGBA__Sequence__fini(&ros_message->visual);
    }
  ...
  // Field name: collision
  {
    ...
    if (ros_message->collision.data) {
      std_msgs__msg__ColorRGBA__Sequence__fini(&ros_message->collision);
    }
...
static uint32_t _ObjectColor__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tesseract_msgs__msg__ObjectColor(
...
static size_t _ObjectColor__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tesseract_msgs__msg__ObjectColor(
