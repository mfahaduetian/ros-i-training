...
static const _NormalFilterParams_type_support_symbol_names_t _NormalFilterParams_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, industrial_reconstruction_msgs, msg, NormalFilterParams)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, industrial_reconstruction_msgs, msg, NormalFilterParams)),
  }
};
...
{
  return &::industrial_reconstruction_msgs::msg::rosidl_typesupport_cpp::NormalFilterParams_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, industrial_reconstruction_msgs, msg, NormalFilterParams)() {
  return get_message_type_support_handle<industrial_reconstruction_msgs::msg::NormalFilterParams>();
}
