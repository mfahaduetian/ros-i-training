...
#include "pick_and_place_msgs/srv/detail/get_target_pose__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/pose__functions.h"  // remove_at_poses
#include "rosidl_runtime_c/string.h"  // ar_tag_frame_id, world_frame_id
#include "rosidl_runtime_c/string_functions.h"  // ar_tag_frame_id, world_frame_id
...
using _GetTargetPose_Request__ros_msg_type = pick_and_place_msgs__srv__GetTargetPose_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: ar_tag_frame_id
  {
    const rosidl_runtime_c__String * str = &ros_message->ar_tag_frame_id;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  // Field name: remove_at_poses
  {
    ...
    auto array_ptr = ros_message->remove_at_poses.data;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: ar_tag_frame_id
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->ar_tag_frame_id.data) {
      rosidl_runtime_c__String__init(&ros_message->ar_tag_frame_id);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->ar_tag_frame_id,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'ar_tag_frame_id'\n");
      return false;
    }
  }
  ...
  // Field name: remove_at_poses
  {
    ...
    if (ros_message->remove_at_poses.data) {
      geometry_msgs__msg__Pose__Sequence__fini(&ros_message->remove_at_poses);
    }
    if (!geometry_msgs__msg__Pose__Sequence__init(&ros_message->remove_at_poses, size)) {
      fprintf(stderr, "failed to create array for field 'remove_at_poses'");
      return false;
    }
    auto array_ptr = ros_message->remove_at_poses.data;
    for (size_t i = 0; i < size; ++i) {
...
static uint32_t _GetTargetPose_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_pick_and_place_msgs__srv__GetTargetPose_Request(
...
static size_t _GetTargetPose_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pick_and_place_msgs__srv__GetTargetPose_Request(
...
using _GetTargetPose_Response__ros_msg_type = pick_and_place_msgs__srv__GetTargetPose_Response;
...
{
  return static_cast<uint32_t>(
    get_serialized_size_pick_and_place_msgs__srv__GetTargetPose_Response(
      untyped_ros_message, 0));
}
...
static size_t _GetTargetPose_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pick_and_place_msgs__srv__GetTargetPose_Response(
    full_bounded, is_plain, 0);
...
// already included above
// #include "pick_and_place_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "pick_and_place_msgs/srv/get_target_pose.h"
