...
static const _ToolPath_type_support_symbol_names_t _ToolPath_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, snp_msgs, msg, ToolPath)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, snp_msgs, msg, ToolPath)),
  }
};
...
{
  return &::snp_msgs::msg::rosidl_typesupport_cpp::ToolPath_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, snp_msgs, msg, ToolPath)() {
  return get_message_type_support_handle<snp_msgs::msg::ToolPath>();
}
