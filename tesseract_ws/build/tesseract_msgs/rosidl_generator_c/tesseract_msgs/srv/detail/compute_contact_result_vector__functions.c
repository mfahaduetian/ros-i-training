...
bool
tesseract_msgs__srv__ComputeContactResultVector_Request__are_equal(const tesseract_msgs__srv__ComputeContactResultVector_Request * lhs, const tesseract_msgs__srv__ComputeContactResultVector_Request * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
tesseract_msgs__srv__ComputeContactResultVector_Request__copy(
  const tesseract_msgs__srv__ComputeContactResultVector_Request * input,
  tesseract_msgs__srv__ComputeContactResultVector_Request * output)
{
  if (!input || !output) {
    return false;
  }
...
tesseract_msgs__srv__ComputeContactResultVector_Request__create()
{
  ...
  tesseract_msgs__srv__ComputeContactResultVector_Request * msg = (tesseract_msgs__srv__ComputeContactResultVector_Request *)allocator.allocate(sizeof(tesseract_msgs__srv__ComputeContactResultVector_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
...
tesseract_msgs__srv__ComputeContactResultVector_Request__Sequence__init(tesseract_msgs__srv__ComputeContactResultVector_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tesseract_msgs__srv__ComputeContactResultVector_Request *)allocator.zero_allocate(size, sizeof(tesseract_msgs__srv__ComputeContactResultVector_Request), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tesseract_msgs__srv__ComputeContactResultVector_Request__Sequence * array = (tesseract_msgs__srv__ComputeContactResultVector_Request__Sequence *)allocator.allocate(sizeof(tesseract_msgs__srv__ComputeContactResultVector_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
tesseract_msgs__srv__ComputeContactResultVector_Request__Sequence__are_equal(const tesseract_msgs__srv__ComputeContactResultVector_Request__Sequence * lhs, const tesseract_msgs__srv__ComputeContactResultVector_Request__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tesseract_msgs__srv__ComputeContactResultVector_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
tesseract_msgs__srv__ComputeContactResultVector_Request__Sequence__copy(
  const tesseract_msgs__srv__ComputeContactResultVector_Request__Sequence * input,
  tesseract_msgs__srv__ComputeContactResultVector_Request__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tesseract_msgs__srv__ComputeContactResultVector_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    tesseract_msgs__srv__ComputeContactResultVector_Request * data =
      (tesseract_msgs__srv__ComputeContactResultVector_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tesseract_msgs__srv__ComputeContactResultVector_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tesseract_msgs__srv__ComputeContactResultVector_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!tesseract_msgs__srv__ComputeContactResultVector_Request__copy(
...
bool
tesseract_msgs__srv__ComputeContactResultVector_Response__are_equal(const tesseract_msgs__srv__ComputeContactResultVector_Response * lhs, const tesseract_msgs__srv__ComputeContactResultVector_Response * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  // collision_result
  if (!tesseract_msgs__msg__ContactResultVector__are_equal(
      &(lhs->collision_result), &(rhs->collision_result)))
  {
    return false;
  }
  // success
...
bool
tesseract_msgs__srv__ComputeContactResultVector_Response__copy(
  const tesseract_msgs__srv__ComputeContactResultVector_Response * input,
  tesseract_msgs__srv__ComputeContactResultVector_Response * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  if (!tesseract_msgs__msg__ContactResultVector__copy(
      &(input->collision_result), &(output->collision_result)))
  {
    return false;
  }
  // success
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tesseract_msgs__srv__ComputeContactResultVector_Response * msg = (tesseract_msgs__srv__ComputeContactResultVector_Response *)allocator.allocate(sizeof(tesseract_msgs__srv__ComputeContactResultVector_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
...
tesseract_msgs__srv__ComputeContactResultVector_Response__Sequence__init(tesseract_msgs__srv__ComputeContactResultVector_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tesseract_msgs__srv__ComputeContactResultVector_Response *)allocator.zero_allocate(size, sizeof(tesseract_msgs__srv__ComputeContactResultVector_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tesseract_msgs__srv__ComputeContactResultVector_Response__Sequence * array = (tesseract_msgs__srv__ComputeContactResultVector_Response__Sequence *)allocator.allocate(sizeof(tesseract_msgs__srv__ComputeContactResultVector_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
tesseract_msgs__srv__ComputeContactResultVector_Response__Sequence__are_equal(const tesseract_msgs__srv__ComputeContactResultVector_Response__Sequence * lhs, const tesseract_msgs__srv__ComputeContactResultVector_Response__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tesseract_msgs__srv__ComputeContactResultVector_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
tesseract_msgs__srv__ComputeContactResultVector_Response__Sequence__copy(
  const tesseract_msgs__srv__ComputeContactResultVector_Response__Sequence * input,
  tesseract_msgs__srv__ComputeContactResultVector_Response__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tesseract_msgs__srv__ComputeContactResultVector_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    tesseract_msgs__srv__ComputeContactResultVector_Response * data =
      (tesseract_msgs__srv__ComputeContactResultVector_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tesseract_msgs__srv__ComputeContactResultVector_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tesseract_msgs__srv__ComputeContactResultVector_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!tesseract_msgs__srv__ComputeContactResultVector_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
