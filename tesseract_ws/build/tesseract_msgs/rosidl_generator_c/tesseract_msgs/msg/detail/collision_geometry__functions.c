...
bool
tesseract_msgs__msg__CollisionGeometry__are_equal(const tesseract_msgs__msg__CollisionGeometry * lhs, const tesseract_msgs__msg__CollisionGeometry * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // geometry
  if (!tesseract_msgs__msg__Geometry__are_equal(
      &(lhs->geometry), &(rhs->geometry)))
  {
    return false;
  }
  // material
  if (!tesseract_msgs__msg__Material__are_equal(
...
bool
tesseract_msgs__msg__CollisionGeometry__copy(
  const tesseract_msgs__msg__CollisionGeometry * input,
  tesseract_msgs__msg__CollisionGeometry * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  // material
  if (!tesseract_msgs__msg__Material__copy(
...
tesseract_msgs__msg__CollisionGeometry__create()
{
  ...
  tesseract_msgs__msg__CollisionGeometry * msg = (tesseract_msgs__msg__CollisionGeometry *)allocator.allocate(sizeof(tesseract_msgs__msg__CollisionGeometry), allocator.state);
  if (!msg) {
    return NULL;
  }
...
tesseract_msgs__msg__CollisionGeometry__Sequence__init(tesseract_msgs__msg__CollisionGeometry__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tesseract_msgs__msg__CollisionGeometry *)allocator.zero_allocate(size, sizeof(tesseract_msgs__msg__CollisionGeometry), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tesseract_msgs__msg__CollisionGeometry__Sequence * array = (tesseract_msgs__msg__CollisionGeometry__Sequence *)allocator.allocate(sizeof(tesseract_msgs__msg__CollisionGeometry__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
tesseract_msgs__msg__CollisionGeometry__Sequence__are_equal(const tesseract_msgs__msg__CollisionGeometry__Sequence * lhs, const tesseract_msgs__msg__CollisionGeometry__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tesseract_msgs__msg__CollisionGeometry__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
tesseract_msgs__msg__CollisionGeometry__Sequence__copy(
  const tesseract_msgs__msg__CollisionGeometry__Sequence * input,
  tesseract_msgs__msg__CollisionGeometry__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tesseract_msgs__msg__CollisionGeometry);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    tesseract_msgs__msg__CollisionGeometry * data =
      (tesseract_msgs__msg__CollisionGeometry *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tesseract_msgs__msg__CollisionGeometry__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tesseract_msgs__msg__CollisionGeometry__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!tesseract_msgs__msg__CollisionGeometry__copy(
