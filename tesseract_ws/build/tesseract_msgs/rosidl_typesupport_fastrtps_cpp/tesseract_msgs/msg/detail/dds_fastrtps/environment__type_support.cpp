...
#include "tesseract_msgs/msg/detail/environment__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const tesseract_msgs::msg::Environment *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tesseract_msgs::msg::Environment *>(
    untyped_ros_message);
...
{
  return &tesseract_msgs::msg::typesupport_fastrtps_cpp::_Environment__handle;
}
