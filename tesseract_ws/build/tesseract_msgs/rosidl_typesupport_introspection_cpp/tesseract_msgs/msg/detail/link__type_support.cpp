...
void fetch_function__Link__visual(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const tesseract_msgs::msg::VisualGeometry *>(
    get_const_function__Link__visual(untyped_member, index));
  auto & value = *reinterpret_cast<tesseract_msgs::msg::VisualGeometry *>(untyped_value);
  value = item;
}

void assign_function__Link__visual(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<tesseract_msgs::msg::VisualGeometry *>(
    get_function__Link__visual(untyped_member, index));
  const auto & value = *reinterpret_cast<const tesseract_msgs::msg::VisualGeometry *>(untyped_value);
  item = value;
}
...
void fetch_function__Link__collision(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const tesseract_msgs::msg::CollisionGeometry *>(
    get_const_function__Link__collision(untyped_member, index));
  auto & value = *reinterpret_cast<tesseract_msgs::msg::CollisionGeometry *>(untyped_value);
  value = item;
}

void assign_function__Link__collision(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<tesseract_msgs::msg::CollisionGeometry *>(
    get_function__Link__collision(untyped_member, index));
  const auto & value = *reinterpret_cast<const tesseract_msgs::msg::CollisionGeometry *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Link_message_member_array[4] = {
  ...
  },
  {
    ...
    fetch_function__Link__visual,  // fetch(index, &value) function pointer
    assign_function__Link__visual,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__Link__collision,  // fetch(index, &value) function pointer
    assign_function__Link__collision,  // assign(index, value) function pointer
