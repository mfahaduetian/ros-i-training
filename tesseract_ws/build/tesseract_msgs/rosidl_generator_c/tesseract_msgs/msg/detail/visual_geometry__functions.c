...
tesseract_msgs__msg__VisualGeometry__create()
{
  ...
  tesseract_msgs__msg__VisualGeometry * msg = (tesseract_msgs__msg__VisualGeometry *)allocator.allocate(sizeof(tesseract_msgs__msg__VisualGeometry), allocator.state);
  if (!msg) {
    return NULL;
  }
...
tesseract_msgs__msg__VisualGeometry__Sequence__init(tesseract_msgs__msg__VisualGeometry__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tesseract_msgs__msg__VisualGeometry *)allocator.zero_allocate(size, sizeof(tesseract_msgs__msg__VisualGeometry), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tesseract_msgs__msg__VisualGeometry__Sequence * array = (tesseract_msgs__msg__VisualGeometry__Sequence *)allocator.allocate(sizeof(tesseract_msgs__msg__VisualGeometry__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
tesseract_msgs__msg__VisualGeometry__Sequence__are_equal(const tesseract_msgs__msg__VisualGeometry__Sequence * lhs, const tesseract_msgs__msg__VisualGeometry__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tesseract_msgs__msg__VisualGeometry__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  tesseract_msgs__msg__VisualGeometry__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tesseract_msgs__msg__VisualGeometry);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    tesseract_msgs__msg__VisualGeometry * data =
      (tesseract_msgs__msg__VisualGeometry *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tesseract_msgs__msg__VisualGeometry__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tesseract_msgs__msg__VisualGeometry__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!tesseract_msgs__msg__VisualGeometry__copy(
