...
#include "tesseract_msgs/msg/detail/joint_calibration__rosidl_typesupport_fastrtps_c.h"
...
using _JointCalibration__ros_msg_type = tesseract_msgs__msg__JointCalibration;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _JointCalibration__ros_msg_type * ros_message = static_cast<const _JointCalibration__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _JointCalibration__ros_msg_type * ros_message = static_cast<_JointCalibration__ros_msg_type *>(untyped_ros_message);
  // Field name: reference_position
  {
    cdr >> ros_message->reference_position;
  }
...
static uint32_t _JointCalibration__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tesseract_msgs__msg__JointCalibration(
...
static size_t _JointCalibration__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tesseract_msgs__msg__JointCalibration(
...
static message_type_support_callbacks_t __callbacks_JointCalibration = {
  "tesseract_msgs::msg",
  "JointCalibration",
...
static rosidl_message_type_support_t _JointCalibration__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_JointCalibration,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tesseract_msgs, msg, JointCalibration)() {
  return &_JointCalibration__type_support;
}
