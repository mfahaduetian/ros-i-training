...
#include "tesseract_msgs/msg/detail/planning_request__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const tesseract_msgs::msg::PlannerProfileRemapping &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  tesseract_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.move_profile_remapping,
    cdr);
  // Member: composite_profile_remapping
  tesseract_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.composite_profile_remapping,
    cdr);
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tesseract_msgs::msg::PlanningRequest & ros_message)
{
  // Member: environment_state
  ...
  size_t current_alignment)
{
  ...
  // Member: environment_state
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        tesseract_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_EnvironmentState(
  ...
  // Member: move_profile_remapping
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        tesseract_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_PlannerProfileRemapping(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
...
{
  auto typed_message =
    static_cast<const tesseract_msgs::msg::PlanningRequest *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tesseract_msgs::msg::PlanningRequest *>(
    untyped_ros_message);
...
{
  return &tesseract_msgs::msg::typesupport_fastrtps_cpp::_PlanningRequest__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tesseract_msgs, msg, PlanningRequest)() {
  return &tesseract_msgs::msg::typesupport_fastrtps_cpp::_PlanningRequest__handle;
}
