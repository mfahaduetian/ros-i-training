...
bool tesseract_msgs__msg__joint_group__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tesseract_msgs.msg._joint_group.JointGroup", full_classname_dest, 42) == 0);
  }
  tesseract_msgs__msg__JointGroup * ros_message = _ros_message;
  {  // name
...
{
  /* NOTE(esteve): Call constructor of JointGroup */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tesseract_msgs.msg._joint_group");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "JointGroup");
