...
#ifndef TESSERACT_MSGS__MSG__DETAIL__COLLISION_GEOMETRY__STRUCT_HPP_
#define TESSERACT_MSGS__MSG__DETAIL__COLLISION_GEOMETRY__STRUCT_HPP_
...
struct CollisionGeometry_
{
  ...
  explicit CollisionGeometry_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : origin(_init),
    geometry(_init),
    material(_init)
  {
  ...
  explicit CollisionGeometry_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : name(_alloc),
    origin(_alloc, _init),
...
#endif  // TESSERACT_MSGS__MSG__DETAIL__COLLISION_GEOMETRY__STRUCT_HPP_
