...
#include "tesseract_msgs/msg/detail/contact_result_vector__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const tesseract_msgs::msg::ContactResult &,
  ...
  size_t current_alignment)
{
  ...
  // Member: contacts
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        tesseract_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_ContactResult(
...
{
  auto typed_message =
    static_cast<const tesseract_msgs::msg::ContactResultVector *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tesseract_msgs::msg::ContactResultVector *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ContactResultVector__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const tesseract_msgs::msg::ContactResultVector *>(
...
static size_t _ContactResultVector__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ContactResultVector(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ContactResultVector__callbacks = {
  "tesseract_msgs::msg",
  "ContactResultVector",
...
static rosidl_message_type_support_t _ContactResultVector__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ContactResultVector__callbacks,
...
{
  return &tesseract_msgs::msg::typesupport_fastrtps_cpp::_ContactResultVector__handle;
}
