...
tesseract_msgs__msg__Material__init(tesseract_msgs__msg__Material * msg)
{
  ...
  // texture_filename
  if (!rosidl_runtime_c__String__init(&msg->texture_filename)) {
    tesseract_msgs__msg__Material__fini(msg);
    return false;
  }
  // color
...
tesseract_msgs__msg__Material__fini(tesseract_msgs__msg__Material * msg)
{
  ...
  // texture_filename
  rosidl_runtime_c__String__fini(&msg->texture_filename);
  // color
...
bool
tesseract_msgs__msg__Material__are_equal(const tesseract_msgs__msg__Material * lhs, const tesseract_msgs__msg__Material * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // texture_filename
  if (!rosidl_runtime_c__String__are_equal(
      &(lhs->texture_filename), &(rhs->texture_filename)))
  {
    return false;
  }
  // color
...
bool
tesseract_msgs__msg__Material__copy(
  const tesseract_msgs__msg__Material * input,
  tesseract_msgs__msg__Material * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  // texture_filename
  if (!rosidl_runtime_c__String__copy(
      &(input->texture_filename), &(output->texture_filename)))
  {
    return false;
  }
  // color
...
tesseract_msgs__msg__Material__create()
{
  ...
  tesseract_msgs__msg__Material * msg = (tesseract_msgs__msg__Material *)allocator.allocate(sizeof(tesseract_msgs__msg__Material), allocator.state);
  if (!msg) {
    return NULL;
  }
...
tesseract_msgs__msg__Material__Sequence__init(tesseract_msgs__msg__Material__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tesseract_msgs__msg__Material *)allocator.zero_allocate(size, sizeof(tesseract_msgs__msg__Material), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tesseract_msgs__msg__Material__Sequence * array = (tesseract_msgs__msg__Material__Sequence *)allocator.allocate(sizeof(tesseract_msgs__msg__Material__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
tesseract_msgs__msg__Material__Sequence__are_equal(const tesseract_msgs__msg__Material__Sequence * lhs, const tesseract_msgs__msg__Material__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tesseract_msgs__msg__Material__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
tesseract_msgs__msg__Material__Sequence__copy(
  const tesseract_msgs__msg__Material__Sequence * input,
  tesseract_msgs__msg__Material__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tesseract_msgs__msg__Material);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    tesseract_msgs__msg__Material * data =
      (tesseract_msgs__msg__Material *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tesseract_msgs__msg__Material__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tesseract_msgs__msg__Material__fini(&output->data[i]);
        }
        return false;
      }
    }
