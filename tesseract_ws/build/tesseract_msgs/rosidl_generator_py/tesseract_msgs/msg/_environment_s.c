...
bool tesseract_msgs__msg__environment__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tesseract_msgs.msg._environment.Environment", full_classname_dest, 43) == 0);
  }
  tesseract_msgs__msg__Environment * ros_message = _ros_message;
  {  // command_history
...
PyObject * tesseract_msgs__msg__environment__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tesseract_msgs.msg._environment");
