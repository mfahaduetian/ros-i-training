...
#include "tesseract_msgs/msg/detail/link_group__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // links, name
#include "rosidl_runtime_c/string_functions.h"  // links, name

// forward declare type support functions


using _LinkGroup__ros_msg_type = tesseract_msgs__msg__LinkGroup;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _LinkGroup__ros_msg_type * ros_message = static_cast<const _LinkGroup__ros_msg_type *>(untyped_ros_message);
  // Field name: name
  {
  ...
  void * untyped_ros_message)
{
  ...
  _LinkGroup__ros_msg_type * ros_message = static_cast<_LinkGroup__ros_msg_type *>(untyped_ros_message);
  // Field name: name
  {
    std::string tmp;
    cdr >> tmp;
  ...
  // Field name: links
  {
    ...
    if (ros_message->links.data) {
      rosidl_runtime_c__String__Sequence__fini(&ros_message->links);
    }
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      bool succeeded = rosidl_runtime_c__String__assign(
        ...
        tmp.c_str());
      if (!succeeded) {
        fprintf(stderr, "failed to assign string into field 'links'\n");
        return false;
      }
    }
  }
...
static uint32_t _LinkGroup__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tesseract_msgs__msg__LinkGroup(
...
static size_t _LinkGroup__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tesseract_msgs__msg__LinkGroup(
...
static message_type_support_callbacks_t __callbacks_LinkGroup = {
  "tesseract_msgs::msg",
  "LinkGroup",
...
static rosidl_message_type_support_t _LinkGroup__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_LinkGroup,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tesseract_msgs, msg, LinkGroup)() {
  return &_LinkGroup__type_support;
}
