...
#include "tesseract_msgs/msg/detail/groups_joint_state__rosidl_typesupport_fastrtps_c.h"
...
#include "tesseract_msgs/msg/detail/string_double_pair__functions.h"  // joint_state
...
using _GroupsJointState__ros_msg_type = tesseract_msgs__msg__GroupsJointState;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _GroupsJointState__ros_msg_type * ros_message = static_cast<const _GroupsJointState__ros_msg_type *>(untyped_ros_message);
  // Field name: name
  {
  ...
  void * untyped_ros_message)
{
  ...
  _GroupsJointState__ros_msg_type * ros_message = static_cast<_GroupsJointState__ros_msg_type *>(untyped_ros_message);
  // Field name: name
  {
    std::string tmp;
    cdr >> tmp;
  ...
  // Field name: joint_state
  {
    ...
    if (ros_message->joint_state.data) {
      tesseract_msgs__msg__StringDoublePair__Sequence__fini(&ros_message->joint_state);
    }
    if (!tesseract_msgs__msg__StringDoublePair__Sequence__init(&ros_message->joint_state, size)) {
...
size_t get_serialized_size_tesseract_msgs__msg__GroupsJointState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GroupsJointState__ros_msg_type * ros_message = static_cast<const _GroupsJointState__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _GroupsJointState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tesseract_msgs__msg__GroupsJointState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tesseract_msgs
size_t max_serialized_size_tesseract_msgs__msg__GroupsJointState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _GroupsJointState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tesseract_msgs__msg__GroupsJointState(
...
static message_type_support_callbacks_t __callbacks_GroupsJointState = {
  "tesseract_msgs::msg",
  "GroupsJointState",
...
static rosidl_message_type_support_t _GroupsJointState__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_GroupsJointState,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tesseract_msgs, msg, GroupsJointState)() {
  return &_GroupsJointState__type_support;
}
