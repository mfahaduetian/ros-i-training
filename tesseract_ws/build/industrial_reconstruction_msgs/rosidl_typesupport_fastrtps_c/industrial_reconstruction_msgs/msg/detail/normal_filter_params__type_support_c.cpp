...
#include "industrial_reconstruction_msgs/msg/detail/normal_filter_params__rosidl_typesupport_fastrtps_c.h"
...
using _NormalFilterParams__ros_msg_type = industrial_reconstruction_msgs__msg__NormalFilterParams;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _NormalFilterParams__ros_msg_type * ros_message = static_cast<const _NormalFilterParams__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _NormalFilterParams__ros_msg_type * ros_message = static_cast<_NormalFilterParams__ros_msg_type *>(untyped_ros_message);
  // Field name: normal_direction
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _NormalFilterParams__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_industrial_reconstruction_msgs__msg__NormalFilterParams(
...
static size_t _NormalFilterParams__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_industrial_reconstruction_msgs__msg__NormalFilterParams(
...
static message_type_support_callbacks_t __callbacks_NormalFilterParams = {
...
static rosidl_message_type_support_t _NormalFilterParams__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_NormalFilterParams,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, industrial_reconstruction_msgs, msg, NormalFilterParams)() {
  return &_NormalFilterParams__type_support;
}
