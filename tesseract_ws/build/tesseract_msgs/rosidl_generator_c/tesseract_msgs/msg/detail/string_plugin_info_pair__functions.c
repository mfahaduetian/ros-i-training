...
tesseract_msgs__msg__StringPluginInfoPair__init(tesseract_msgs__msg__StringPluginInfoPair * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->first)) {
    tesseract_msgs__msg__StringPluginInfoPair__fini(msg);
    return false;
  }
  // second
  if (!tesseract_msgs__msg__PluginInfo__init(&msg->second)) {
    tesseract_msgs__msg__StringPluginInfoPair__fini(msg);
    return false;
  }
  return true;
...
tesseract_msgs__msg__StringPluginInfoPair__fini(tesseract_msgs__msg__StringPluginInfoPair * msg)
{
  ...
  // second
  tesseract_msgs__msg__PluginInfo__fini(&msg->second);
}
...
tesseract_msgs__msg__StringPluginInfoPair__are_equal(const tesseract_msgs__msg__StringPluginInfoPair * lhs, const tesseract_msgs__msg__StringPluginInfoPair * rhs)
{
  ...
  // second
  if (!tesseract_msgs__msg__PluginInfo__are_equal(
...
tesseract_msgs__msg__StringPluginInfoPair__create()
{
  ...
  tesseract_msgs__msg__StringPluginInfoPair * msg = (tesseract_msgs__msg__StringPluginInfoPair *)allocator.allocate(sizeof(tesseract_msgs__msg__StringPluginInfoPair), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(tesseract_msgs__msg__StringPluginInfoPair));
  bool success = tesseract_msgs__msg__StringPluginInfoPair__init(msg);
  if (!success) {
...
tesseract_msgs__msg__StringPluginInfoPair__Sequence__init(tesseract_msgs__msg__StringPluginInfoPair__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tesseract_msgs__msg__StringPluginInfoPair * data = NULL;

  if (size) {
    data = (tesseract_msgs__msg__StringPluginInfoPair *)allocator.zero_allocate(size, sizeof(tesseract_msgs__msg__StringPluginInfoPair), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = tesseract_msgs__msg__StringPluginInfoPair__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        tesseract_msgs__msg__StringPluginInfoPair__fini(&data[i - 1]);
      }
...
tesseract_msgs__msg__StringPluginInfoPair__Sequence__fini(tesseract_msgs__msg__StringPluginInfoPair__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      tesseract_msgs__msg__StringPluginInfoPair__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tesseract_msgs__msg__StringPluginInfoPair__Sequence * array = (tesseract_msgs__msg__StringPluginInfoPair__Sequence *)allocator.allocate(sizeof(tesseract_msgs__msg__StringPluginInfoPair__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = tesseract_msgs__msg__StringPluginInfoPair__Sequence__init(array, size);
  if (!success) {
...
tesseract_msgs__msg__StringPluginInfoPair__Sequence__destroy(tesseract_msgs__msg__StringPluginInfoPair__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    tesseract_msgs__msg__StringPluginInfoPair__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
tesseract_msgs__msg__StringPluginInfoPair__Sequence__are_equal(const tesseract_msgs__msg__StringPluginInfoPair__Sequence * lhs, const tesseract_msgs__msg__StringPluginInfoPair__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tesseract_msgs__msg__StringPluginInfoPair__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  tesseract_msgs__msg__StringPluginInfoPair__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tesseract_msgs__msg__StringPluginInfoPair);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    tesseract_msgs__msg__StringPluginInfoPair * data =
      (tesseract_msgs__msg__StringPluginInfoPair *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tesseract_msgs__msg__StringPluginInfoPair__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tesseract_msgs__msg__StringPluginInfoPair__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!tesseract_msgs__msg__StringPluginInfoPair__copy(
