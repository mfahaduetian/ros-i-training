...
#include "tesseract_msgs/msg/detail/joint_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const tesseract_msgs::msg::JointState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tesseract_msgs::msg::JointState *>(
    untyped_ros_message);
...
{
  return &tesseract_msgs::msg::typesupport_fastrtps_cpp::_JointState__handle;
}
